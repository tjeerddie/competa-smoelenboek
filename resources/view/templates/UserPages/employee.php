              ...
              <form method="post" enctype="multipart/form-data" autocomplete="off">
                <div class="form__group grid__row">
                  ...
                  <div class="form__group grid__column-lg-7 grid__row">
                    ...
                    <input class="form__control grid__column-lg-8" type="text" id="inputFirstName" name="first_name" value="<?= $employee->getFirstName();?>" placeholder="First name" required autofocus>
                  </div>
                  <div class="form__group grid__column-lg-7 grid__row">
                    <label class="form__label grid__column-lg-4" for="inputLastName">last name*</label>
                    <input class="form__control grid__column-lg-8" type="text" id="inputLastName" name="last_name" value="<?= $employee->getLastName();?>" placeholder="Last name" required>
                  </div>
                  <div class="form__group grid__column-lg-7 grid__row">
                    <label class="form__label grid__column-lg-4" for="inputEmail">email*</label>
                    <input class="form__control grid__column-lg-8" type="email" id="inputEmail" name="email" value="<?= $employee->getEmail();?>" placeholder="Email" required>
                  </div>
                  <div class="form__group grid__column-lg-7 grid__row">
                    <label class="form__label grid__column-lg-4" for="inputPhone">phone</label>
                    <input class="form__control grid__column-lg-8" type="tel" id="inputPhone" name="phone_number" value="<?= $employee->getPhoneNumber();?>" placeholder="Phone number">
                  </div>
                  ...
                  <div class="form__group grid__column-lg-7 grid__row">
                    ...
                    <?php foreach ($groups as $group) :
                      if ($employee->getGroupId() === $group->getId()) :?>
                        <select class="form__control grid__column-lg-8" id="selectGroupName" name="group_id" value="<?= $group->getName();?>">
                          <?php foreach ($groups as $group) :
                            if($employee->getGroupId() === $group->getId()) {
                  ...
                  <div class="form__margin grid__row grid__column-sm-6 grid__column--offset-sm-3">
                    ...
                    <button class="button button--reset grid__column-sm-5 grid__column-sm-3" type="reset" value="Reset">reset</button>
                  </div>
                </div>
              </form>
            </div>
